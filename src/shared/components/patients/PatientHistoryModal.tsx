                  ...
                  {isLoading ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-lg font-medium text-gray-700 dark:text-gray-300">
                        {searchTerm ? 'No se encontraron casos que coincidan con la búsqueda' : 'No hay casos registrados para este paciente'}
                      </p>
                      {searchTerm && (
                        <Button 
                        ...
                        >
                          <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-3">
                            <div className="flex items-center gap-2">
                              ...
                              <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(caseItem.payment_status)}`}>
