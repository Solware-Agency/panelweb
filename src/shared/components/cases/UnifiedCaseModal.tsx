												...
												<div className="mt-8 border-t border-gray-200 dark:border-gray-700 pt-6">
													<div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
														...
														<p className="text-sm text-red-700 dark:text-red-400 mb-4">
															Esta acción eliminará permanentemente el caso y todos sus datos asociados. Esta acción no
															se puede deshacer.
														</p>
														<Button
															type="button"
									...
									<div className="bg-white dark:bg-background rounded-xl shadow-2xl max-w-md w-full">
										<div className="p-6">
											...
											<p className="text-gray-600 dark:text-gray-400 mb-4">
												...
												<strong>{case_.code || case_.id?.slice(-6).toUpperCase()}</strong> de{' '}
												<strong>{case_.full_name}</strong>?
											</p>

											<div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-3 mb-6">
												<p className="text-sm text-red-800 dark:text-red-300">
													<strong>Advertencia:</strong> Esta acción no se puede deshacer. Todos los datos asociados a
													este caso serán eliminados permanentemente.
												</p>
											</div>
