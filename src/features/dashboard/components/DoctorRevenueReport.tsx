                ...
                <table className="w-full">
                  <thead className="sticky top-0 bg-white dark:bg-background z-10">
                    <tr className="border-b border-gray-200 dark:border-gray-700">
                      <th className="text-left py-3 px-2 text-gray-600 dark:text-gray-400 font-semibold text-xs">Médico Tratante</th>
                      ...
                      <th className="text-right py-3 px-2 text-gray-600 dark:text-gray-400 font-semibold text-xs">% del Total</th>
                    </tr>
                  </thead>
                  <tbody>
