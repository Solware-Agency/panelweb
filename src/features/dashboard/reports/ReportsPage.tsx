				...
				<div className="bg-white dark:bg-background rounded-xl p-3 sm:p-5 overflow-hidden">
					...
					<div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
						{[
							...
							<div key={index} className="text-center group-hover:bg-gray-50 dark:group-hover:bg-gray-800/30 p-3 rounded-lg transition-all duration-300 hover:scale-[1.02] cursor-pointer">
								<div className={`p-1.5 sm:p-2 rounded-lg mb-2 mx-auto w-fit group-hover:scale-110 transition-transform duration-300 ${
										metric.color === 'blue'
								...
								>
									<metric.icon className={`w-4 h-4 sm:w-5 sm:h-5 group-hover:scale-110 transition-transform duration-300 ${
											metric.color === 'blue'
