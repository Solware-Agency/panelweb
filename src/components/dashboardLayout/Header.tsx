...
const Header: React.FC<HeaderProps> = ({ isDark, toggleDarkMode, currentDate, onMenuClick }) => {
	...
	return (
		<div className="bg-white/80 dark:bg-gray-900/90 backdrop-blur-[10px] rounded-bl-xl transition-colors duration-300 ml-2 sm:ml-5 sticky top-0 left-0 z-30 shadow-xl">
