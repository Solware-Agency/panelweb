...
const MedicalRecordsTable: React.FC<MedicalRecordsTableProps> = ({ onCaseSelect }) => {
	...
	const getStatusColor = (status: string) => {
		switch (status) {
			...
			default:
				return 'bg-orange-100 text-orange-800 dark:bg-orange-500/30 dark:text-orange-200'
		}
	}
							...
							<tbody className="divide-y divide-gray-200 dark:divide-gray-700">
								{filteredAndSortedCases.map((case_) => (
									...
									>
										...
										<td className="px-4 py-4 text-sm text-gray-900 dark:text-gray-100">{case_.age} años</td>
