	...
	return (
		<div className="p-3 sm:p-6">
			<div className="mb-4 sm:mb-6">
				<h1 className="text-2xl sm:text-3xl font-bold text-gray-700 dark:text-gray-300 mb-2">Reportes y Análisis</h1>
				<p className="text-gray-600 dark:text-gray-400">Informes detallados sobre el rendimiento de tu negocio</p>
			</div>

			{/* Quick Actions */}
			<div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
				<button className="bg-white/80 dark:bg-gray-900/80 rounded-xl p-3 sm:p-4 transition-colors duration-300 hover:bg-white/90 dark:hover:bg-gray-900/90 flex items-center gap-2 sm:gap-3">
			...
			<div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
				...
				<div className="bg-white/80 dark:bg-gray-900/80 rounded-xl p-4 sm:p-6 transition-colors duration-300">
					<div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6">
						<h3 className="text-lg sm:text-xl font-bold text-gray-700 dark:text-gray-300 mb-2 sm:mb-0">Servicios Más Vendidos</h3>
					...
					<div className="space-y-3 sm:space-y-4">
						{[
							...
							<div key={index} className={`p-3 sm:p-4 rounded-xl bg-gradient-to-r ${
								...
								<div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-3">
									<div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-0">
										...
										<div>
											<h4 className="font-medium text-gray-700 dark:text-gray-300 text-sm sm:text-base">{service.name}</h4>
											<p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">{service.projects} proyectos completados</p>
										</div>
									</div>
				...
				{/* Revenue Breakdown */}
				<div className="bg-white/80 dark:bg-gray-900/80 rounded-xl p-4 sm:p-6 transition-colors duration-300">
					<h3 className="text-lg sm:text-xl font-bold text-gray-700 dark:text-gray-300 mb-4 sm:mb-6">Desglose de Ingresos</h3>
			...
			<div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
				{/* Top Clients */}
				<div className="xl:col-span-2 bg-white/80 dark:bg-gray-900/80 rounded-xl p-4 sm:p-6 transition-colors duration-300">
					<div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6">
						<h3 className="text-lg sm:text-xl font-bold text-gray-700 dark:text-gray-300 mb-2 sm:mb-0">Análisis de Clientes</h3>
						<div className="flex items-center gap-2">
						...
						<table className="w-full min-w-full">
							<thead>
								<tr className="border-b border-gray-200 dark:border-gray-700">
									...
									<th className="text-left py-3 text-gray-600 dark:text-gray-400 font-medium text-sm hidden sm:table-cell">Satisfacción</th>
							...
							<tbody>
								{[
									...
									<tr key={index} className="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/50">
										...
										<td className="py-4 text-gray-700 dark:text-gray-300 font-medium text-sm">${client.revenue.toLocaleString()}</td>
				...
				{/* Client Metrics */}
				<div className="bg-white/80 dark:bg-gray-900/80 rounded-xl p-4 sm:p-6 transition-colors duration-300">
					<h3 className="text-base sm:text-lg font-bold text-gray-700 dark:text-gray-300 mb-4 sm:mb-6">Métricas de Cliente</h3>
			...
			{/* Performance Summary */}
			<div className="bg-white/80 dark:bg-gray-900/80 rounded-xl p-4 sm:p-6 transition-colors duration-300">
				<h3 className="text-lg sm:text-xl font-bold text-gray-700 dark:text-gray-300 mb-4 sm:mb-6">Resumen de Rendimiento</h3>
				<div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
					{[
						...
						<div key={index} className="text-center">
							<div className={`p-2 sm:p-3 rounded-lg mb-3 mx-auto w-fit ${
