...
const StatsPage: React.FC = () => {
	return (
		<div className="p-6">
			<div className="mb-6">
				<h1 className="text-3xl font-bold text-gray-700 dark:text-gray-300 mb-2">Estadísticas Detalladas</h1>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
				...
				<div className="bg-white/80 dark:bg-gray-900/80 rounded-xl p-6 transition-colors duration-300">
					...
					<div>
						...
						<p className="text-3xl font-bold text-gray-700 dark:text-gray-300">$85,240</p>
				...
				<div className="bg-white/80 dark:bg-gray-900/80 rounded-xl p-6 transition-colors duration-300">
					...
					<div>
						...
						<p className="text-3xl font-bold text-gray-700 dark:text-gray-300">2,580</p>
				...
				<div className="bg-white/80 dark:bg-gray-900/80 rounded-xl p-6 transition-colors duration-300">
					...
					<div>
						...
						<p className="text-3xl font-bold text-gray-700 dark:text-gray-300">127</p>
				...
				<div className="bg-white/80 dark:bg-gray-900/80 rounded-xl p-6 transition-colors duration-300">
					...
					<div>
						...
						<p className="text-3xl font-bold text-gray-700 dark:text-gray-300">68.4%</p>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
				...
				<div className="bg-white/80 dark:bg-gray-900/80 rounded-xl p-6 transition-colors duration-300">
					<div className="flex items-center justify-between mb-6">
						<h3 className="text-xl font-bold text-gray-700 dark:text-gray-300">Tendencia de Ingresos</h3>
				...
				<div className="bg-white/80 dark:bg-gray-900/80 rounded-xl p-6 transition-colors duration-300">
					<h3 className="text-xl font-bold text-gray-700 dark:text-gray-300 mb-6">Distribución de Servicios</h3>
						...
						<div className="relative size-48">
							...
							<div className="absolute inset-0 flex items-center justify-center">
								<div className="text-center">
									<p className="text-2xl font-bold text-gray-700 dark:text-gray-300">$85k</p>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
				{/* Top Clients Table */}
				<div className="bg-white/80 dark:bg-gray-900/80 rounded-xl p-6 transition-colors duration-300">
					<h3 className="text-xl font-bold text-gray-700 dark:text-gray-300 mb-6">Clientes Principales</h3>
						...
						<table className="w-full">
							<thead>
								<tr className="border-b border-gray-200 dark:border-gray-700">
									...
									<th className="text-left py-3 text-gray-600 dark:text-gray-400 font-medium">Total</th>
								</tr>
							</thead>
							<tbody>
								<tr className="border-b border-gray-100 dark:border-gray-800">
									<td className="py-3">
										<div>
											<p className="font-medium text-gray-700 dark:text-gray-300">TechCorp SA</p>
											<p className="text-sm text-gray-500 dark:text-gray-400">Desarrollo Web</p>
										</div>
									</td>
									<td className="py-3 text-gray-700 dark:text-gray-300">8</td>
									<td className="py-3 text-gray-700 dark:text-gray-300 font-medium">$24,500</td>
								</tr>
								<tr className="border-b border-gray-100 dark:border-gray-800">
									<td className="py-3">
										<div>
											<p className="font-medium text-gray-700 dark:text-gray-300">InnovateLtd</p>
											<p className="text-sm text-gray-500 dark:text-gray-400">Automatización</p>
										</div>
									</td>
									<td className="py-3 text-gray-700 dark:text-gray-300">5</td>
									<td className="py-3 text-gray-700 dark:text-gray-300 font-medium">$18,200</td>
								</tr>
								<tr className="border-b border-gray-100 dark:border-gray-800">
									<td className="py-3">
										<div>
											<p className="font-medium text-gray-700 dark:text-gray-300">StartupXYZ</p>
											<p className="text-sm text-gray-500 dark:text-gray-400">Agentes IA</p>
										</div>
									</td>
									<td className="py-3 text-gray-700 dark:text-gray-300">3</td>
									<td className="py-3 text-gray-700 dark:text-gray-300 font-medium">$12,800</td>
								</tr>
								<tr>
									<td className="py-3">
										<div>
											<p className="font-medium text-gray-700 dark:text-gray-300">GlobalTech</p>
											<p className="text-sm text-gray-500 dark:text-gray-400">Desarrollo Web</p>
										</div>
									</td>
									<td className="py-3 text-gray-700 dark:text-gray-300">6</td>
									<td className="py-3 text-gray-700 dark:text-gray-300 font-medium">$15,600</td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				{/* Performance Metrics */}
				<div className="bg-white/80 dark:bg-gray-900/80 rounded-xl p-6 transition-colors duration-300">
					<h3 className="text-xl font-bold text-gray-700 dark:text-gray-300 mb-6">Métricas de Rendimiento</h3>
