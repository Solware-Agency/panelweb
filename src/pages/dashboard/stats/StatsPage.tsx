	...
	return (
		<div className="p-3 sm:p-6">
			<div className="mb-4 sm:mb-6">
				<h1 className="text-2xl sm:text-3xl font-bold text-gray-700 dark:text-gray-300 mb-2">Estadísticas Detalladas</h1>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
				...
				<div className="bg-white/80 dark:bg-gray-900/80 rounded-xl p-4 sm:p-6 transition-colors duration-300">
					<div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 sm:mb-6">
						<h3 className="text-lg sm:text-xl font-bold text-gray-700 dark:text-gray-300 mb-2 sm:mb-0">Tendencia de Ingresos</h3>
				...
				<div className="bg-white/80 dark:bg-gray-900/80 rounded-xl p-4 sm:p-6 transition-colors duration-300">
					<h3 className="text-lg sm:text-xl font-bold text-gray-700 dark:text-gray-300 mb-4 sm:mb-6">Distribución de Servicios</h3>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
				{/* Top Clients Table */}
				<div className="bg-white/80 dark:bg-gray-900/80 rounded-xl p-4 sm:p-6 transition-colors duration-300">
					<h3 className="text-lg sm:text-xl font-bold text-gray-700 dark:text-gray-300 mb-4 sm:mb-6">Clientes Principales</h3>
				...
				{/* Performance Metrics */}
				<div className="bg-white/80 dark:bg-gray-900/80 rounded-xl p-4 sm:p-6 transition-colors duration-300">
					<h3 className="text-lg sm:text-xl font-bold text-gray-700 dark:text-gray-300 mb-4 sm:mb-6">Métricas de Rendimiento</h3>
