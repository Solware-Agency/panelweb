		...
		<>
			<main className="p-3 sm:p-5">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 lg:gap-2">
					...
					<div className="col-span-1 sm:col-span-2 lg:col-span-3 row-span-1 lg:row-span-2 bg-gradient-to-br from-white/90 to-blue-50/80 dark:from-gray-900/90 dark:to-gray-900/30 dark:hover:bg-gray-900/30 rounded-xl py-4 sm:py-6 px-4 sm:px-8 transition-all duration-300 flex flex-col sm:flex-row items-center justify-between border border-blue-100 dark:border-blue-800/30 shadow-lg hover:shadow-xl">
						...
						<div className="relative">
							...
							<EyeTrackingComponent
								className={
									'size-24 sm:size-32 lg:size-40 drop-shadow-[0px_10px_20px_rgba(59,130,246,0.3)] dark:drop-shadow-[0px_10px_20px_rgba(147,197,253,0.3)] transition-all duration-300 hover:scale-105 relative z-10'
								}
							/>
						</div>
					</div>
					...
					<div 
						className="col-span-1 sm:col-span-2 lg:col-span-3 row-span-1 lg:row-span-2 bg-gradient-to-br from-white/90 to-blue-50/80 dark:from-gray-900/90 dark:to-gray-900/30 dark:hover:bg-gray-900/30 rounded-xl py-4 sm:py-6 px-4 sm:px-8 transition-all duration-300 cursor-pointer hover:shadow-xl group border border-purple-100 dark:border-purple-800/30 shadow-lg"
							...
							<div className="flex-1 w-full space-y-3 sm:space-y-4">
								<div className="flex items-center justify-between p-2 sm:p-3 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl border border-blue-200 dark:border-blue-800/30">
									<div className="flex items-center gap-2 sm:gap-3">
										...
										<div>
											<p className="font-medium text-gray-700 dark:text-gray-300 text-sm sm:text-base">Automatización</p>
								...
								<div className="flex items-center justify-between p-2 sm:p-3 bg-gradient-to-r from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 rounded-xl border border-red-200 dark:border-red-800/30">
									<div className="flex items-center gap-2 sm:gap-3">
										...
										<div>
											<p className="font-medium text-gray-700 dark:text-gray-300 text-sm sm:text-base">Desarrollo Web</p>
					...
					<div 
						className='col-span-1 sm:col-span-1 lg:col-span-2 row-span-1 lg:row-span-2 bg-gradient-to-br from-white/90 to-blue-50/80 dark:from-gray-900/90 dark:to-gray-900/30 dark:hover:bg-gray-900/30 rounded-xl py-4 sm:py-5 px-4 sm:px-6 transition-colors duration-300 flex flex-col justify-between cursor-pointer hover:bg-white/90 group'
						onClick={() => navigate('/dashboard/stats')}
					>
					...
					<div 
						className='col-span-1 sm:col-span-2 lg:col-span-4 row-span-1 lg:row-span-2 bg-gradient-to-br from-white/90 to-blue-50/80 dark:from-gray-900/90 dark:to-gray-900/30 dark:hover:bg-gray-900/30 rounded-xl py-4 sm:py-5 px-4 sm:px-6 transition-colors duration-300 cursor-pointer hover:bg-white/90 group'
						onClick={() => navigate('/dashboard/stats')}
					>
						<div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4">
							<h3 className="text-base sm:text-lg font-bold text-gray-700 dark:text-gray-300 mb-2 sm:mb-0">Tendencia de Ventas</h3>
							<div className="flex items-center gap-2">
								<div className="flex items-center gap-2">
					...
					{/* Grid 6 - Calendar Preview */}
					<div 
						className='col-span-1 sm:col-span-1 lg:col-span-2 row-span-1 lg:row-span-4 bg-gradient-to-br from-white/90 to-blue-50/80 dark:from-gray-900/90 dark:to-gray-900/30 dark:hover:bg-gray-900/30 rounded-xl py-4 sm:py-5 px-4 sm:px-6 transition-colors duration-300 flex flex-col cursor-pointer hover:bg-white/90 group'
					...
					<div 
						className='col-span-1 sm:col-span-2 lg:col-span-3 row-span-1 lg:row-span-2 bg-gradient-to-br from-white/90 to-blue-50/80 dark:from-gray-900/90 dark:to-gray-900/30 rounded-xl py-4 sm:py-5 px-4 sm:px-6 transition-colors duration-300 cursor-pointer hover:bg-white/90 dark:hover:bg-gray-900/30 group'
						onClick={() => navigate('/dashboard/reports')}
					>
						<div className="flex items-center justify-between mb-4">
							<h3 className="text-base sm:text-lg font-bold text-gray-700 dark:text-gray-300">Servicios Más Vendidos</h3>
							<ArrowRight className="w-3 h-3 sm:w-4 sm:h-4 text-gray-400 group-hover:text-blue-500 transition-colors" />
						</div>
					...
					<div className='col-span-1 sm:col-span-2 lg:col-span-3 row-span-1 lg:row-span-2 bg-gradient-to-br from-white/90 to-blue-50/80 dark:from-gray-900/90 dark:to-gray-900/30 dark:hover:bg-gray-900/30 rounded-xl py-4 sm:py-5 px-4 sm:px-6 transition-colors duration-300'>
						<div className="flex items-center justify-between mb-4">
