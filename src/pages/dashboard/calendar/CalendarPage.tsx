	...
	return (
		<div className="p-3 sm:p-6">
			<div className="mb-4 sm:mb-6">
				<h1 className="text-2xl sm:text-3xl font-bold text-gray-700 dark:text-gray-300 mb-2">Calendario</h1>
			...
			<div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6">
				...
				<div className="xl:col-span-2">
					<div className="bg-white/80 dark:bg-gray-900/80 rounded-xl p-3 sm:p-6 transition-colors duration-300">
						{/* Calendar Header */}
						...
						<div className="grid grid-cols-7 gap-0 mb-4">
							{['Dom', 'Lun', 'Mar', 'Mié', 'Jue', 'Vie', 'Sáb'].map(day => (
								<div key={day} className="p-2 sm:p-3 text-center text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 border-b border-gray-200 dark:border-gray-700">
									{day}
								</div>
							))}
						</div>
					...
					<div className="bg-white/80 dark:bg-gray-900/80 rounded-xl p-4 sm:p-6 transition-colors duration-300">
						...
						<div className="space-y-3">
							{events.slice(0, 3).map(event => (
								<div key={event.id} className="flex items-center gap-3 p-2 sm:p-3 hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-lg transition-colors">
